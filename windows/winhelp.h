...
#define WINHELP_CTX_xyzmodem_remote_download_command_enable "xyzmodem:remote-download-command-enable"
#define WINHELP_CTX_xyzmodem_downloaddir "xyzmodem:downloaddir"
